...
// 리스트 렌더링 :
// - JSX 내부에서 반복적으로 랜더링하는 요소에 대해 반복 처리
...
export default function ListRendering() {
  ...
  const humans: Human[] = [
    ...
    { name: '김민수', age: 12, job: '학생'},                // 마지막 요소에 콤마(,) 찍어도 돌아감
  ];
...
const count = new Array(3).fill(0);
  ...
  return (
    <>
        ...
        {['요소1', '요소2', '요소3']}
        {humans.map((item, index) => {
            // return <ListItem name={item.name} age={item.age} job={item.job} />   // 아래(spread 연산자이용)와 같음
